...
**Before making substantial changes**, read `docs/current-priority.md` to understand the active phase. For architecture/product decisions read `docs/architecture.md`, `docs/data-model.md`, and `docs/decisions.md`.
