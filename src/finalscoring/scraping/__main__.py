...
from finalscoring.scraping.spiders import SpaceBiffSpider, SpielDesJahresSpider

SPIDERS = {spider.name: spider for spider in (SpielDesJahresSpider, SpaceBiffSpider)}
