...
its which-one-wins rule — the schema carries no uniqueness constraint,
so this step is the only thing standing between a twice-cited critic and
a skewed aggregate. See `DECISIONS_OPEN.md`.
